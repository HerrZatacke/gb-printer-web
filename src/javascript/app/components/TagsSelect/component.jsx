      ...
      <ul className="tags-select">
        ...
        >
          <button
            type="button"
            className="tags-select__button tags-select__button--add"
            onClick={() => this.props.updateTags('add', this.state.newTag)}
          >
            <SVG name="add" />
          </button>
          <button
            type="button"
            className="tags-select__button tags-select__button--remove"
            onClick={() => this.props.updateTags('remove', this.state.newTag)}
          >
            <SVG name="remove" />
          </button>
          <input
            type="text"
            className="tags-select__tag-name tags-select__tag-name--input"
            onChange={({ target }) => {
              this.setState({
                newTag: target.value,
              });
